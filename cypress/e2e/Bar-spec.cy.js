describe('Bar page', () => {
  ...
  it("should allow a user to add their own drink", () => {
    ...
    cy.get(".img-input").type("https://images.unsplash.com/photo-1630541010111-1bd604c9aba2?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2787&q=80")
    cy.get(".add-input").type("2 Cups Ice")
    cy.get(".steps-input").type("Shake, pour over ice, and serve!")
    cy.get('.css-17e40sj').click();
    cy.intercept("https://re-sip-e-be.fly.dev/graphql", {
