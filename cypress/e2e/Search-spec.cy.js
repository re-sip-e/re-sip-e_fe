describe("Search Page", () => {
  it("should display all elements to the DOM on load", () => {
    ...
    cy.get(".search-form-container > .chakra-heading")
      .should("exist")
      .should("contain", "Search for your favorite cocktails!");
    cy.get(".search-msg-box")
      .should("exist")
      .should("contain", "Type in the name of a cocktail and get mixing");
  ...
  it("should display an error message if there are no drinks available", () => {
    ...
    cy.get(".search-msg-box").contains(
  ...
  it("should route a user to an info page for a specific cocktail", () => {
    ...
    cy.url().should("eq", "http://localhost:3000/11003");
  });
