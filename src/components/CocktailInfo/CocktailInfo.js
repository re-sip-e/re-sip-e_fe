  ...
  return loading ? (
    ...
    <div>
      ...
      <div className="cocktail-details-container">
        <img src={!checkBar ? data.apiDrink.imgUrl : data.drink.imgUrl} alt="drink-img"/>
        <div className="cocktail-details">
          ...
          {checkBar ? (
            ...
            <Button className="add-to-bar-btn" onClick={() => addToBar()} size={'lg'} color='white' bgColor="#37867B" _hover={{background: "#307168"}}>Add to my bar!</Button>
          )}
          </div>
        </div>
      )}
