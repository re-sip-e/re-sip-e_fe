...
import "./NavBar.css";
import { IconButton, Avatar, Image } from "@chakra-ui/react";
  ...
  return (
    <section className='alt-header'>
        <div className='alt-header-box head-2'>
          <Link to="/">
                <img src={siteLogo} alt="re-sip-e logo" height="180" width="180" className='site-logo'/>
          </Link>
        <nav className="second-header head-2">
          <div className="second-header-list head-2">
            ...
            <div className="header-avatar">
              <NavLink to="/profile">
                <Avatar name="Joe Schmoe" src="https://bit.ly/ryan-florence" size={"lg"} />
              </NavLink>
            </div>
          </div>
        </nav>
